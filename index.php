...
function debug_show($value, $type = 'DEBUG', $verbose = false) {
    if (isset($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'], 'FirePHP') !== false && (ENVIRONMENT == 'development' || $_COOKIE['hzsrv_online_debug'] == 1)) {
        //检测到安装了FirePHP时，
 ...
 */
	...
	//define('SITE_URL','http://127.0.0.3/');
/*
 * --------------------------------------------------------------------
